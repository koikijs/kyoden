...
class Selectbox extends Component {
  constructor(props) {
    ...
    this.state.focusedIndex = props.options.reduce(
      (memo, option, index) =>
        props.selected && option.value === props.selected.value ? index : memo,
      0
    );
  ...
  handleClickOutside(evt, selectboxDOM, optionsDOM) {
    if (
      (!selectboxDOM || !selectboxDOM.contains(evt.target)) &&
                    ...
                    className={`
                            ...
                            ${
                              ...
                              option.value === this.state.selected.value
                                ? this.props.styles.selectbox.focused
                                : ''
                            }
                          `}
                    href=""
